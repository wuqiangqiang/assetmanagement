...
import com.awlsoft.asset.ui.presenter.ScrapTaskActivityPresenter;
...
public class ScrapTaskActivity extends BaseTaskActivity<ScrapTaskContract.Presenter> implements ScrapTaskContract.View {
    ...
    @Override
    public void showReceiveTaskDetail(ScrapTaskResponse task) {
    ...
    @Override
    protected ScrapTaskContract.Presenter providerPresenter() {
        return new ScrapTaskActivityPresenter(this, DBManager.getInstance(this), new RfidManager(this), taskId);
    }
}
