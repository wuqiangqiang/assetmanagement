...
import com.awlsoft.asset.ui.presenter.BorrowTaskActivityPresenter;
...
public class BorrowTaskActivity extends BaseTaskActivity<BorrowTaskContract.Presenter> implements BorrowTaskContract.View {
    ...
    @Override
    public void showReceiveTaskDetail(BorrowTaskResponse task) {
    ...
    @Override
    protected BorrowTaskContract.Presenter providerPresenter() {
        return new BorrowTaskActivityPresenter(this, DBManager.getInstance(this), new RfidManager(this), taskId);
    }
