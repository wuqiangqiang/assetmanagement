 ...
 */
@Entity
public class BorrowTaskResponse extends BaseTaskResponse {
    ...
    @Generated(hash = 766174088)
    public BorrowTaskResponse(String taskID, String TASK_DEF_KEY_, String BUSINESS_KEY_,
                              Long id, int category_id, String ectID, long keeper_id, String borrow_no,
                              int count, long workarea_id, int status) {
        this.taskID = taskID;
    ...
    @Generated(hash = 1265521321)
    public BorrowTaskResponse() {
    }
