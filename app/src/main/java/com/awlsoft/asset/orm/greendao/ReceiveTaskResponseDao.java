...
/** 
 * DAO for table "RECEIVE_TASK_RESPONSE".
*/
public class ReceiveTaskResponseDao extends AbstractDao<ReceiveTaskResponse, Long> {

    public static final String TABLENAME = "RECEIVE_TASK_RESPONSE";

    /**
     * Properties of entity ReceiveTaskResponse.<br/>
    ...
    public static class Properties {
        ...
        public final static Property Receive_no = new Property(7, String.class, "receive_no", false, "RECEIVE_NO");
    ...
    public ReceiveTaskResponseDao(DaoConfig config) {
        super(config);
    }
    
    public ReceiveTaskResponseDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"RECEIVE_TASK_RESPONSE\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"RECEIVE_TASK_RESPONSE\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, ReceiveTaskResponse entity) {
        stmt.clearBindings();
        ...
        String receive_no = entity.getReceive_no();
        if (receive_no != null) {
            stmt.bindString(8, receive_no);
        }
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, ReceiveTaskResponse entity) {
        stmt.clearBindings();
    ...
    @Override
    public ReceiveTaskResponse readEntity(Cursor cursor, int offset) {
        ReceiveTaskResponse entity = new ReceiveTaskResponse( //
            ...
            cursor.isNull(offset + 7) ? null : cursor.getString(offset + 7), // receive_no
    ...
    @Override
    public void readEntity(Cursor cursor, ReceiveTaskResponse entity, int offset) {
        ...
        entity.setReceive_no(cursor.isNull(offset + 7) ? null : cursor.getString(offset + 7));
    ...
    @Override
    protected final Long updateKeyAfterInsert(ReceiveTaskResponse entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(ReceiveTaskResponse entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(ReceiveTaskResponse entity) {
